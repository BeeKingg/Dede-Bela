...
async def redis(alive):
    user = await bot.get_me()
    await get_readable_time((time.time() - StartTime))
    await alive.edit("__Dede Bela.__")
    await alive.edit("__Cantik Banget..__")
    await alive.edit("__imutttt.__")
    await alive.edit("__Sebentarr..__")
    await alive.edit("__Yaa Gaess...__")
    await alive.edit("__Duarrrr..__")
    await alive.edit("__Userbot Cantik...__")
    await alive.edit("🐣")
